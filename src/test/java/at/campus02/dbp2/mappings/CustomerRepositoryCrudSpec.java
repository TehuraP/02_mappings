...
public class CustomerRepositoryCrudSpec {
    ...
    public void createPersistsCustomerInDatabaseAndReturnsTrue() {
        ...
        //Kontrolle der Werte
        Customer frmDB = manager.find(Customer.class, toCreate.getId());
        assertEquals(firstname, frmDB.getFirstname());
        assertEquals(lastname, frmDB.getLastname());
        assertEquals(accountType, frmDB.getAccountType());
        assertEquals(toCreate, frmDB);
    ...
    //READ
    @Test
    public void readFindsCustomerInDataase() {
        //given
